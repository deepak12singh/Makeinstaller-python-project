...
def show_detailed_help():
    ...
    print("\n1. General Commands:")
    print("   - ProjectName help               : Show this general help message.")
    print("   - ProjectName -h <command>       : Show help for specific commands.")
    
    print("\n2. Running the Script:")
    print("   - ProjectName run here               : Run the script with the current directory as argument.")
    print("   - This command assumes that your PDF files are stored in the current directory.")

    print("\n3. Setting the Generative AI Key:")
    print("   - ProjectName set key <key_value>: Set the Generative AI key for the script.")
    print("   - This key is necessary for accessing certain features.")
    
    print("\n4. Example Commands:")
    print("   - ProjectName help")
    print("   - ProjectName here")
    print("   - ProjectName set key <key_value>")
...
def show_command_help(command):
    ...
    if command == 'run':
        ...
        print("\nCommand: ProjectName here")
        print("\nCommon Use Case:")
        print("   - If your PDFs are stored in the same folder as this script, use the command 'ProjectName here' to run it.")
        ...
        print("\nCommand: ProjectName set key <key_value>")
        print("\nCommon Use Case:")
        ...
        print("\nCommand: ProjectName set <option> <value>")
        print("\nOptions:")
        print("   - key : Set the API key for the script.")
        print("   - <other_option> : Configure other script options.")
        print("\nExample Usage:")
        print("   ProjectName set key <your_api_key>")
        print("=" * 50)
    
    else:
        print("\nInvalid command! Type 'ProjectName help' for general help.")
        print("Try 'ProjectName -h <command>' for more specific help on a particular command.")
