...
def show_detailed_help():
    ...
    print("\n1. General Commands:")
    print("   - MakeInstaller help               : Show this general help message.")
    ...
    print("   - MakeInstaller set key <key_value>: Set the Generative AI key for the script.")
    print("   - This key is necessary for accessing certain features.")
    
    print("\n4. Example Commands:")
    print("   - MakeInstaller help")
    print("   - MakeInstaller here")
    print("   - MakeInstaller set key <key_value>")
...
def show_command_help(command):
    ...
    if command == 'run':
        ...
        print("\nCommand: MakeInstaller here")
        print("\nCommon Use Case:")
        print("   - If your PDFs are stored in the same folder as this script, use the command 'MakeInstaller here' to run it.")
        ...
        print("\nCommand: MakeInstaller set key <key_value>")
        print("\nCommon Use Case:")
        ...
        print("\nCommand: MakeInstaller set <option> <value>")
        print("\nOptions:")
        print("   - key : Set the API key for the script.")
        print("   - <other_option> : Configure other script options.")
        print("\nExample Usage:")
        print("   MakeInstaller set key <your_api_key>")
        print("=" * 50)
    
    else:
        print("\nInvalid command! Type 'MakeInstaller help' for general help.")
        print("Try 'MakeInstaller -h <command>' for more specific help on a particular command.")
